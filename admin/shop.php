  ...
  <form id="filtersForm" method="get" class="bg-neutral-900 border border-neutral-800 p-3 rounded">
    <div class="grid md:grid-cols-2 gap-3">
      ...
      <div class="relative">
        ...
        <input id="categoryInput" name="category" value="<?= e($cat) ?>" placeholder="Filter by category (e.g., rings)" class="pl-10 w-full bg-neutral-800 border border-neutral-700 rounded px-3 py-2" />
      </div>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" id="productsContainer">
  <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
    <?php foreach ($products as $p): ?>
      <div class="group block bg-neutral-900 border border-neutral-800 rounded overflow-hidden hover:shadow-xl hover:shadow-gold/10 transition relative">
  ...
  (function(){
    ...
    async function fetchAndReplace(url){
      ...
      try {
        ...
        container.outerHTML = html; // replace entire section
